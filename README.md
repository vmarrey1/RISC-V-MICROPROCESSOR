...
Potential improvements for a more advanced implementation:
- Branch prediction (e.g., 2-bit predictor)
- Instruction and data caches
- Exception handling and interrupts
- Additional instruction sets (M, A, F, D extensions)
- Out-of-order execution
- Superscalar design (multiple instructions per cycle)
...
Designed as a demonstration of digital design and computer architecture principles.
